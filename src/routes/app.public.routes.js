  ...
  return (
    <NavigationContainer independent={true}>
      <Stack.Navigator initialRouteName="Splash">
        ...
        />
        <Stack.Screen
          name="Cadastro_Inicio"
          component={Cadastro_Inicio}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="Cadastro_Email"
          component={Cadastro_Email}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="Cadastro_Celular"
          component={Cadastro_Celular}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="Codigo_SMS"
          component={Codigo_SMS}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="Como_Comecar"
          component={Como_Comecar}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="Forms_Passageiro"
          component={Forms_Passageiro}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="Forms_Motorista"
          component={Forms_Motorista}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="Forms_Motorista_Veiculo"
          component={Forms_Motorista_Veiculo}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="ModoPassageiro"
          component={ModoPassageiro}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="ModoMotorista"
          component={ModoMotorista}
          options={{headerShown: false}}
        />
        {/*  */}
        <Stack.Screen
