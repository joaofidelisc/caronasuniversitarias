  ...
  return (
    <SafeAreaView>
      ...
      <View
        ...
        <TouchableOpacity
          style={{position: 'absolute', left: '10%', top: '56%'}}>
          <Text
            style={{
              fontWeight: '600',
              fontSize: height * 0.014,
        ...
        <TouchableOpacity
          style={{position: 'absolute', left: '10%', top: '64%'}}>
          <Text
            style={{
              fontWeight: '600',
              fontSize: height * 0.014,
        ...
        <TouchableOpacity
          style={{position: 'absolute', left: '10%', top: '68%'}}>
          <Text
            style={{
              fontWeight: '600',
              fontSize: height * 0.014,
        ...
        <TouchableOpacity
          style={{position: 'absolute', left: '10%', top: '72%'}}>
          <Text
            style={{
              fontWeight: '600',
              fontSize: height * 0.014,
